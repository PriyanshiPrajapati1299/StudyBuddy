      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl p-8 space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 text-sm mt-1">
            {role === 'Mentor' ? 'Start mentoring and inspire learners.' : 'Start your learning journey today!'}
          </p>
        </div>
              ...
              {showPwd ? (
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none"
                  ...
                  <path strokeLinecap="round" strokeLinejoin="round"
                        d="M13.875 18.825A10.05 10.05 0 0112 19c-4.477 0-8.268-2.943-9.542-7a9.98 9.98 0 012.093-3.42m1.414-1.414A9.969 9.969 0 0112 5c4.477 0 8.268 2.943 9.542 7a9.967 9.967 0 01-1.054 2.235M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
